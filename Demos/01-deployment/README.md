# DEMO: Deploy SharePoint Framework solutions to tenant App Catalog

This completed project is the result of the lab exercise **Deploy SharePoint Framework solutions to tenant App Catalog** that is referenced in the [README](../../) in this repo.
